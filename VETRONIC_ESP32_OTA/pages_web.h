ACText(caption,"<h2>Communication avec la borne VETRONIC</h2><p><a href='/pilotage'>Pilotage de charge et solaire Deye</a></p>","text-align:center;color:#2f4f4f;margin:10px;","",AC_Tag_BR);
